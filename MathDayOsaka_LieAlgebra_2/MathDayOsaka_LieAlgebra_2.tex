...
\declaretheoremstyle[thmbox=M,bodyfont=\upshape,notefont=\bfseries]{mystyle}
\declaretheoremstyle[qed=\qedsymbol,bodyfont=\upshape,notefont=\bfseries]{myproofstyle}
\declaretheorem[style=mystyle,numberwithin=section]{definition}
\declaretheorem[style=mystyle,sibling=definition]{theorem}
\declaretheorem[style=mystyle,sibling=definition]{proposition}
\declaretheorem[style=mystyle,sibling=definition]{example}
\declaretheorem[style=myproofstyle,name=Proof,numbered=no]{myproof}
